        ...
        <div class="container">
            <div class="row">
                  ...
                  <div class="container" id="modal">  
                    ...
                    <!-- SIGN IN -->
        <div id="loginbox" style="margin-top:10px; padding-right: 20px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        ...
        <div class="col-lg-12">
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <div class="form-group" align="center">
                   <?php echo Html::submitButton( '<i class="fa fa-key"><span style="font-family:  sans-serif ;"> Sign In</span></i>', ['class' => 'btn btn-danger', 'name' => 'login-button']); ?>
                </div>
